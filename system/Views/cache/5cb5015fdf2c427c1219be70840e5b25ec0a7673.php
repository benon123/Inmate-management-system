...
<head>
    ...
    <style> .no-js #loader { display: none;  }  .js #loader { display: block; position: absolute; left: 100px; top: 0; }
        .se-pre-con {position: fixed;left: 0;top: 0;width: 100%;height: 100%;z-index: 9999;background: url(<?php echo e(asset('imgs/site/preloader.gif')); ?>) center no-repeat #fff;
...
<body>
    ...
    <div class="container-fluid bg-light text-dark mt-3">
        ...
        <div class="d-flex justify-content-between">
            <p>Copyright &copy; <?php echo e(date('Y')); ?> Inmate</p>
...
</body><?php /**PATH C:\xampp\htdocs\Inmate-management-system\app\views/partials/app.blade.php ENDPATH**/ ?>